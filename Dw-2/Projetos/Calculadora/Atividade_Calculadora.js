 ...
 ****************************************************************/
// Botões
const btnBotoes = document.querySelectorAll("[btn-numero]"); // All- pois são vários botões
 ...
 ****************************************************************/
// Botão AC
btnAC.addEventListener("click", () => { // Define a função no click daquele botão
...
// Botões dos números
// for (let i = 0; i <  btnBotoes.length; i++){ //i++ = i+=1. 
//     btnBotoes[i].addEventListener("click", () => {
//         adicionaNumero(calculadora, btnBotoes[0].innerText)
//     })
// }

for (let btn of btnBotoes) { //quando não precisa saber a posição do elemento usar esse for
...
for (let btn of btnOperacoes) { //quando não precisa saber a posição do elemento usar esse for
  btn.addEventListener("click", () => {
